...
["gdp", "game/game.dart", , U, {
  ...
  Game: {
    ...
    update$1: function(dt) {
      var t1, t2, t3;
      if ($.ObjectManager_instance.goList.length === 0)
  ...
  MainMenu: {
    ...
    draw$0: function() {
      ...
      t7 = t1.framew;
      t8 = t1.frameh;
      t6.drawImageScaledFromSource$9(t6, t1.img, t1.spritex, t1.spritey, t7, t8, t2 - t3 / 2, t4 - t5 / 2, t7, t8);
    },
    update$1: function(dt) {
      var t1;
      this.input.toString;
  ...
  Block: {
    ...
    draw$0: function() {
      var t1, t2, t3, t4, t5, t6, t7, t8, pattern, t9;
      t1 = this.height;
      if (t1 <= 100) {
        t2 = this.boulder;
        t3 = this.x;
        ...
        t7 = t2.framew;
        t8 = t2.frameh;
        t6.drawImageScaledFromSource$9(t6, t2.img, t2.spritex, t2.spritey, t7, t8, t3 - t4 / 2, t5 - t1 / 2, t7, t8);
      } else {
        J.save$0$x($.normContext);
    ...
    draw$0: function() {
      ...
      if (this.state !== this.stateEnumDead && !this.blink) {
        ...
        if (t1 && this.LOOK_RIGHT) {
          ...
          t7 = t1.framew;
          t8 = t1.frameh;
          t6.drawImageScaledFromSource$9(t6, t1.img, 225, 200, t7, t8, t2 - t3 / 2 - this.imgXOffset, t4 - t5 / 2 + this.imgYOffset, t7, t8);
          ...
          t7 = t1.framew;
          t8 = t1.frameh;
          t6.drawImageScaledFromSource$9(t6, t1.img, 225, 300, t7, t8, t2 - t3 / 2 - this.imgXOffset, t4 - t5 / 2 + this.imgYOffset, t7, t8);
        } else if (t1) {
          t1 = this.sprite;
          t1.spritex = 225;
          t1.spritey = 200;
          ...
          if (t1 && this.LOOK_RIGHT) {
            ...
            t8 = t1.framew;
            t9 = t1.frameh;
            t7.drawImageScaledFromSource$9(t7, t1.img, t2, 0, t8, t9, t3 - t4 / 2 - this.imgXOffset, t5 - t6 / 2 + this.imgYOffset, t8, t9);
          } else if (t1 && this.LOOK_LEFT) {
            t1 = this.sprite;
            t2 = t1.spritex;
            if (t2 <= 0) {
            ...
            t8 = t1.framew;
            t9 = t1.frameh;
            t7.drawImageScaledFromSource$9(t7, t1.img, t2, 100, t8, t9, t3 - t4 / 2 - this.imgXOffset, t5 - t6 / 2 + this.imgYOffset, t8, t9);
          } else {
            t1 = this.LOOK_LEFT;
            t2 = $.context;
            t3 = this.sprite;
            ...
            if (t1) {
              ...
              t9 = t3.framew;
              t10 = t3.frameh;
              t2.drawImageScaledFromSource$9(t2, t3.img, 825, 100, t9, t10, t1 - t6 / 2 - t4, t7 - t8 / 2 + t5, t9, t10);
            } else {
              t3.spritex = 0;
              t3.spritey = 0;
              t1 = this.x;
              ...
              t9 = t3.framew;
              t10 = t3.frameh;
              t2.drawImageScaledFromSource$9(t2, t3.img, 0, 0, t9, t10, t1 - t6 / 2 - t4, t7 - t8 / 2 + t5, t9, t10);
            }
          }
        }
      }
  ...
  ShipItem: {
    ...
    draw$0: function() {
      ...
      t8 = t1.framew;
      t9 = t1.frameh;
      t7.drawImageScaledFromSource$9(t7, t1.img, t2, t1.spritey, t8, t9, t3 - t4 / 2, t5 - t6 / 2, t8, t9);
    },
    collect$0: function() {
...
["", "main.dart", , F, {
  ...
  main: [function() {
    ...
    if ($.Game_instance == null) {
      ...
      t1.MainMenu$0();
      t1 = new U.Game(t2, t1, new P.Stopwatch(null, null), 0, new U.LevelManager(), null, 1, 2, 3, null, 0, 0, 0, 0, 0);
      $.Game_instance = t1;
      t1.Initialize$0();
    }
