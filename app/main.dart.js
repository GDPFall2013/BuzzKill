...
["_isolate_helper", "dart:_isolate_helper", , H, {
  ...
  ReceivePortImpl: {
    ...
    close$0: [function(_) {
      ...
      t1 = this._controller;
      t1.close$0(t1);
    }, "call$0" /* tearOffInfo */, "get$close", 0, 0, 0],
...
["camera", "game/camera/camera.dart", , T, {
  "": "",
  AdjustedContext: {
    ...
    lineTo$2: function(_, x, y) {
      var t1, t2;
      t1 = this.context;
      t2 = $.Camera_instance.screenRatio;
      J.lineTo$2$x(t1, x * t2 + this.xAdjust, y * t2 + this.yAdjust);
    },
...
["dart.async", "dart:async", , P, {
  ...
  }, "call$0" /* tearOffInfo */, "_asyncRunCallback$closure", 0, 0, 0],
  ...
  }, "call$1" /* tearOffInfo */, "_nullDataHandler$closure", 2, 0, 1],
  ...
  }, null, "call$2" /* tearOffInfo */, "call$1" /* tearOffInfo */, "_nullErrorHandler$closure", 2, 2, 2, 3],
  _nullDoneHandler: [function() {
    return;
  }, "call$0" /* tearOffInfo */, "_nullDoneHandler$closure", 0, 0, 0],
  ...
  _AsyncCompleter: {
    ...
    }, "completeError$1", "call$2" /* tearOffInfo */, "call$1" /* tearOffInfo */, "get$completeError", 2, 2, 14, 3],
    $as_Completer: null
  },
  _Future: {
    ...
    }, "_completeError$1", "call$2" /* tearOffInfo */, "call$1" /* tearOffInfo */, "get$_completeError", 2, 2, 2, 3],
...
["dart.collection", "dart:collection", , P, {
  ...
  }, "call$1" /* tearOffInfo */, "_defaultHashCode$closure", 2, 0, 5],
...
["dart.core", "dart:core", , P, {
  ...
  }, "call$2" /* tearOffInfo */, "identical$closure", 4, 0, 6],
  identityHashCode: [function(object) {
    return H.objectHashCode(object);
  }, "call$1" /* tearOffInfo */, "identityHashCode$closure", 2, 0, 7],
...
["dart.dom.html", "dart:html", , W, {
  ...
  }, "call$1" /* tearOffInfo */, "Element__determineMouseWheelEventType$closure", 2, 0, 8],
...
["game_loop_html", "package:game_loop/game_loop_html.dart", , G, {
  ...
  PointerLock: {
    ...
    }, "call$1" /* tearOffInfo */, "get$_onClick", 2, 0, 20],
    _onPointerLockChange$1: [function($event) {
    }, "call$1" /* tearOffInfo */, "get$_onPointerLockChange", 2, 0, 20],
...
["gdp", "main.dart", , U, {
  ...
  main: [function() {
    ...
    t1 = new T.AdjustedContext(null, null, null);
    ...
    if ($.Game_instance == null) {
      ...
      if (t2 == null) {
        ...
        if (t2 == null) {
          t2 = new U.ObjectManager(H.setRuntimeTypeInfo([], [U.GameObject]), H.setRuntimeTypeInfo([], [U.Block]), H.setRuntimeTypeInfo([], [U.Enemy]), H.setRuntimeTypeInfo([], [U.Item]));
          $.ObjectManager_instance = t2;
        }
        t2 = new U.CollisionSystem(t2, null, null, 0, 0, false);
        $.CollisionSystem_instance = t2;
      }
    ...
    game = $.Game_instance;
    t1 = $.get$gameLoop();
    t1.onUpdate = new U.main_closure(game);
    t1.onRender = new U.main_closure0(game);
    if (!t1._initialized) {
  ...
  }, "call$0" /* tearOffInfo */, "main$closure", 0, 0, 0],
  CollisionSystem: {
    "": "GameObject;check_collision,x,y,height,width,dead",
  ...
  SpriteSheet: {
    "": "Object;spritex,spritey,framew,frameh,imgurl,img"
  },
  SoundManager: {
    "": "Object;ac,_muted,_jumpClip,_oxygenClip,_shipItemClip,_injureClip",
    ...
    draw$0: function() {
      ...
      if (t1 === this.stateEnumPlay) {
        ...
        for (t1 = $.ObjectManager_instance.goList, t1 = new H.ListIterator(t1, t1.length, 0, null); t1.moveNext$0();) {
          ...
          if (typeof t3 !== "number")
            return t3.$add();
          if (t3 + t4 / 2 > $.get$camera().x / -160 / $.Camera_instance.screenRatio) {
            t3 = t2.get$x(go);
            t2 = t2.get$width(go);
            if (typeof t2 !== "number")
              return t2.$div();
            if (typeof t3 !== "number")
              return t3.$sub();
            t2 = t3 - t2 / 2 < ($.get$camera().x + 640 + 160) / $.Camera_instance.screenRatio;
          } else
            t2 = false;
          if (t2)
            go.draw$0();
  ...
  Alien: {
    ...
    initialize$2: function(x, y) {
      ...
      t1.img = U.ImageLoader_getImage("./content/enemies_spritesheet.png");
      this.sprite = t1;
      this.repeat = 0;
      this.initialPos = x;
      this.endPos = x - 150;
    ...
    static: {"": "Alien_GROUND_LEVEL"}
  },
  Block: {
    "": "GameObject;boulder,img,x,y,height,width,dead",
    draw$0: function() {
      var t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, pattern;
      t1 = this.height;
      t2 = this.x;
      if (t1 <= 100) {
        t3 = $.get$camera();
        ...
        t9 = t6.framew;
        t10 = t6.frameh;
        t8.drawImageScaledFromSource$9(t8, t6.img, t6.spritex, t6.spritey, t9, t10, t2 - t4 - t7 / 2, t5 - t3 - t1 / 2, t9, t10);
      } else {
        t1 = $.get$camera();
        t3 = t1.x;
        if (typeof t2 !== "number")
  ...
  Player: {
    "": "GameObject;img,input,JUMPING,WALKING,LOOK_RIGHT,LOOK_LEFT,velocity_y,accel,sprite,stateEnumAlive,stateEnumInjured,stateEnumDead,state,invincibilityTimer,blink,playerStartX,playerStartY,collision,imgXOffset,imgYOffset,x,y,height,width,dead",
    draw$0: function() {
      var t1, t2, t3, cx, cy, t4, t5, t6, t7, t8;
      if (this.state !== this.stateEnumDead && !this.blink) {
        ...
        if (t1 && this.LOOK_RIGHT) {
          ...
          t5 = t1.framew;
          t6 = t1.frameh;
          t4.drawImageScaledFromSource$9(t4, t1.img, 225, 200, t5, t6, cx - t2 / 2 - this.imgXOffset, cy - t3 / 2 + this.imgYOffset, t5, t6);
          ...
          t5 = t1.framew;
          t6 = t1.frameh;
          t4.drawImageScaledFromSource$9(t4, t1.img, 225, 300, t5, t6, cx - t2 / 2 - this.imgXOffset, cy - t3 / 2 + this.imgYOffset, t5, t6);
        } else if (t1) {
          t1 = this.sprite;
          t1.spritex = 225;
          t1.spritey = 200;
          ...
          if (t1 && this.LOOK_RIGHT) {
            ...
            t6 = t1.framew;
            t7 = t1.frameh;
            t5.drawImageScaledFromSource$9(t5, t1.img, t2, 0, t6, t7, cx - t3 / 2 - this.imgXOffset, cy - t4 / 2 + this.imgYOffset, t6, t7);
          } else if (t1 && this.LOOK_LEFT) {
            t1 = this.sprite;
            t2 = t1.spritex;
            if (t2 <= 0) {
            ...
            t6 = t1.framew;
            t7 = t1.frameh;
            t5.drawImageScaledFromSource$9(t5, t1.img, t2, 100, t6, t7, cx - t3 / 2 - this.imgXOffset, cy - t4 / 2 + this.imgYOffset, t6, t7);
          } else {
            t1 = this.LOOK_LEFT;
            t2 = this.sprite;
            t3 = $.context;
            ...
            if (t1) {
              ...
              t7 = t2.framew;
              t8 = t2.frameh;
              t3.drawImageScaledFromSource$9(t3, t2.img, 825, 100, t7, t8, cx - t1 / 2 - t4, cy - t6 / 2 + t5, t7, t8);
            } else {
              t2.spritex = 0;
              t2.spritey = 0;
              t1 = this.width;
              ...
              t7 = t2.framew;
              t8 = t2.frameh;
              t3.drawImageScaledFromSource$9(t3, t2.img, 0, 0, t7, t8, cx - t1 / 2 - t4, cy - t6 / 2 + t5, t7, t8);
            }
          }
        }
      }
  ...
  ShipItem: {
    ...
    draw$0: function() {
      ...
      if (!this.glow) {
        t7 = this.repeat;
        t8 = t7 === 1;
        if (t8 || t7 === 2 || t7 === 3 || t7 === 4 || t7 === 5 || t7 === 6 || t7 === 7 || t7 === 8) {
          if (t8)
            this.repeat = 2;
          else if (t7 === 2)
            this.repeat = 3;
      ...
      t10 = t5.framew;
      t11 = t5.frameh;
      t9.drawImageScaledFromSource$9(t9, t5.img, t6, t5.spritey, t10, t11, t1 - t3 - t7 / 2, t4 - t2 - t8 / 2, t10, t11);
    },
    collect$0: function() {
  ...
  Spike: {
    "": "Enemy;damage,x,y,height,width,dead",
    update$1: function(dt) {
    },
    draw$0: function() {
      var t1, t2, t3, t4, cy, left, bottom, $top, t5, t6, t7, t8;
      t1 = this.x;
      t2 = $.get$camera();
      t3 = t2.x;
      if (typeof t1 !== "number")
      ...
      if (typeof t4 !== "number")
        return t4.$sub();
      cy = t4 - t2;
      left = t1 - t3 - this.width / 2;
      t3 = this.height / 2;
      bottom = cy + t3;
      $top = cy - t3;
      J.save$0$x($.context.context);
      J.beginPath$0$x($.context.context);
      t3 = $.context;
      t1 = t3.context;
      t2 = $.Camera_instance.screenRatio;
      J.moveTo$2$x(t1, left * t2 + t3.xAdjust, bottom * t2 + t3.yAdjust);
      t3 = $.context;
      t3.lineTo$2(t3, left + 1 * this.width / 10, $top);
      t3 = $.context;
      t3.lineTo$2(t3, left + 2 * this.width / 10, bottom);
      t3 = $.context;
      t3.lineTo$2(t3, left + 3 * this.width / 10, $top);
      t3 = $.context;
      t3.lineTo$2(t3, left + 4 * this.width / 10, bottom);
      t3 = $.context;
      t3.lineTo$2(t3, left + 5 * this.width / 10, $top);
      t3 = $.context;
      t3.lineTo$2(t3, left + 6 * this.width / 10, bottom);
      t3 = $.context;
      t3.lineTo$2(t3, left + 7 * this.width / 10, $top);
      t3 = $.context;
      t3.lineTo$2(t3, left + 8 * this.width / 10, bottom);
      t3 = $.context;
      ...
      t5 = this.height;
      t6 = t3.context;
      t7 = $.Camera_instance.screenRatio;
      if (typeof t2 !== "number")
        return t2.$mul();
      t8 = t3.xAdjust;
      if (typeof t1 !== "number")
        return t1.$mul();
      J.clearRect$4$x(t6, t2 * t7 + t8, t1 * t7 + t3.yAdjust, t4 * t7, t5 * t7);
    },
    injure$0: function() {
      return 20;
    }
  ...
  main_closure: {
    ...
    call$1: function(gameLoop) {
      this.game_0.update$1(gameLoop.updateTimeStep * 100);
    }
  },
  main_closure0: {
    "": "Closure:11;game_1",
