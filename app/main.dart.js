...
["gdp", "../game/game.dart", , U, {
  ...
  ImageLoader_getImage: function(url) {
    ...
    if (t1.containsKey$1(url))
      return $.ImageLoader_bufferedImages.$index(0, url);
    ...
    J.set$src$x(img, url);
    $.ImageLoader_bufferedImages.$indexSet(0, url, img);
    return img;
  },
  CollisionSystem: {
  ...
  Game: {
    ...
    Initialize$0: function() {
      ...
      if (!t1._initialized) {
        ...
        H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t4._target, t4._eventType, W._wrapZone(t1.get$_mouseMove()), t4._useCapture), [H.getTypeArgumentByIndex(t4, 0)])._tryResume$0();
        t4 = t3.get$onMouseDown(t2);
        H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t4._target, t4._eventType, W._wrapZone(t1.get$_mouseDown()), t4._useCapture), [H.getTypeArgumentByIndex(t4, 0)])._tryResume$0();
        t4 = t3.get$onMouseUp(t2);
        H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t4._target, t4._eventType, W._wrapZone(t1.get$_mouseUp()), t4._useCapture), [H.getTypeArgumentByIndex(t4, 0)])._tryResume$0();
    ...
    gameOver$0: function() {
      ...
      this.oxygenTimer.stop$0(0);
    },
    reloadLevel$0: function() {
      var t1, t2;
      $.ObjectManager_instance.clear$0(0);
    ...
    loadLevel$1: function(level) {
      ...
      switch (level) {
        ...
        case 2:
          ...
          t1.img = U.ImageLoader_getImage("./content/gameitems.png");
          t1 = new U.Block(t1, W.ImageElement_ImageElement(null, null, null), null, null, 0, 0, false);
          U.GameObject.prototype.initialize$2.call(t1, 13700, 420);
          J.set$src$x(t1.img, "./content/platform.png");
          t1.width = 200;
          t1.height = 140;
          t2.push(t1);
          ...
          t1.width = 126;
          t1.height = 166;
          t6 = new U.SpriteSheet(0, 266, 126, 166, "./content/enemies_spritesheet copy.png", null);
          ...
          t1.img = U.ImageLoader_getImage("./content/gameitems.png");
          t1 = new U.Block(t1, W.ImageElement_ImageElement(null, null, null), null, null, 0, 0, false);
          U.GameObject.prototype.initialize$2.call(t1, 14100, 420);
          J.set$src$x(t1.img, "./content/platform.png");
          t1.width = 200;
          t1.height = 140;
          t2.push(t1);
          ...
          t1.img = U.ImageLoader_getImage("./content/gameitems.png");
          t1 = new U.ShipItem(t1, true, 1, null, null, null, 0, 0, false);
          U.GameObject.prototype.initialize$2.call(t1, 14100, 290);
          t1.height = 90;
          t1.width = 90;
          t1.level = 2;
          t2.push(t1);
  ...
  MainMenu: {
    "": "GameObject;input,sprite,x:gdp$MainMenu$x*,y:gdp$MainMenu$y*,width:gdp$MainMenu$width>,height:gdp$MainMenu$height>,i,spritex,spritey,playGame,options,controls,x,y,height,width,dead",
    draw$0: function() {
    ...
    update$1: function(dt) {
      ...
      if ($.Game_instance.currentLevel === $.LevelManager_enumMainMenu) {
        this.input.toString;
        t1 = $.get$gameLoop()._keyboard.pressed$1(13) && this.playGame;
      } else
        t1 = false;
      if (t1) {
        t1 = $.Game_instance;
    ...
    MainMenu$0: function() {
      ...
      this.gdp$MainMenu$height = 49;
      this.gdp$MainMenu$x = 300;
      this.gdp$MainMenu$y = 200;
      this.input = U.Input_Input();
      this.playGame = true;
      var t1 = new U.SpriteSheet(this.spritex, this.spritey, 150, 147, "./content/menu.png", null);
  ...
  Alien: {
    ...
    draw$0: function() {
      ...
      t10 = t1.framew;
      t1 = t1.frameh;
      t6.drawImageScaledFromSource$9(0, t7, t8, t9, t10, t1, t2 - t3 / 2 - this.imgOffsetX, t4 - t5 / 2 + this.imgOffsetY, t10, t1);
    },
    injure$0: function() {
      return 10;
    },
  ...
  Block: {
    ...
    draw$0: function() {
      var t1, t2, t3, t4, t5, t6, t7, pattern, t8, t9;
      t1 = this.height;
      if (t1 <= 100) {
        t2 = this.boulder;
        t3 = this.x;
        ...
        t6 = t2.framew;
        t7 = t2.frameh;
        $.context.drawImageScaledFromSource$9(0, t2.img, t2.spritex, t2.spritey, t6, t7, t3 - t4 / 2, t5 - t1 / 2, t6, t7);
      } else {
        J.save$0$x($.normContext);
        ...
        t8 = t7.x;
        t9 = t7.screenRatio;
        J.rect$4$x(t6, (t2 - t3 / 2 - t8) * t9 + t1.xAdjust, (t4 - t5 / 2 - t7.y) * t9 + t1.yAdjust, t3 * t9, t5 * t9);
        t9 = $.normContext;
        J.set$fillStyle$x(t9, pattern);
        t9.closePath();
  ...
  InGameMenu: {
    ...
    InGameMenu$0: function() {
      ...
      this.gdp$InGameMenu$height = 49;
      this.gdp$InGameMenu$x = 300;
      this.gdp$InGameMenu$y = 200;
      this.input = U.Input_Input();
      this.resume = true;
      var t1 = new U.SpriteSheet(this.spritex, this.spritey, 150, 198, "./content/menu.png", null);
      t1.img = U.ImageLoader_getImage("./content/menu.png");
      this.sprite = t1;
    }
  },
  ...
  Oxygen: {
    ...
    draw$0: function() {
      ...
      t6 = t1.framew;
      t7 = t1.frameh;
      $.context.drawImageScaledFromSource$9(0, t1.img, t1.spritex, t1.spritey, t6, t7, t2 - t3 / 2, t4 - t5 / 2, t6, t7);
    },
    collect$0: function() {
    ...
    draw$0: function() {
      ...
      if (this.state !== this.stateEnumDead && !this.blink) {
        ...
        if (t1 && this.LOOK_RIGHT) {
          ...
          t6 = t1.framew;
          t7 = t1.frameh;
          $.context.drawImageScaledFromSource$9(0, t1.img, 225, 200, t6, t7, t2 - t3 / 2 - this.imgXOffset, t4 - t5 / 2 + this.imgYOffset, t6, t7);
          ...
          t6 = t1.framew;
          t7 = t1.frameh;
          $.context.drawImageScaledFromSource$9(0, t1.img, 225, 300, t6, t7, t2 - t3 / 2 - this.imgXOffset, t4 - t5 / 2 + this.imgYOffset, t6, t7);
        } else if (t1) {
          t1 = this.sprite;
          t1.spritex = 225;
          t1.spritey = 200;
          ...
          if (t1 && this.LOOK_RIGHT) {
            ...
            t7 = t1.framew;
            t8 = t1.frameh;
            $.context.drawImageScaledFromSource$9(0, t1.img, t2, 0, t7, t8, t3 - t4 / 2 - this.imgXOffset, t5 - t6 / 2 + this.imgYOffset, t7, t8);
          } else if (t1 && this.LOOK_LEFT) {
            t1 = this.sprite;
            t2 = t1.spritex;
            if (t2 <= 0) {
  ...
  ShipItem: {
    ...
    draw$0: function() {
      ...
      t7 = t1.framew;
      t8 = t1.frameh;
      $.context.drawImageScaledFromSource$9(0, t1.img, t2, t1.spritey, t7, t8, t3 - t4 / 2, t5 - t6 / 2, t7, t8);
    },
    collect$0: function() {
  ...
  Spike: {
    ...
    draw$0: function() {
      ...
      $.context.lineTo$2(0, left + 1 * this.width / 10, $top);
      $.context.lineTo$2(0, left + 2 * this.width / 10, bottom);
      $.context.lineTo$2(0, left + 3 * this.width / 10, $top);
      $.context.lineTo$2(0, left + 4 * this.width / 10, bottom);
      $.context.lineTo$2(0, left + 5 * this.width / 10, $top);
      $.context.lineTo$2(0, left + 6 * this.width / 10, bottom);
      $.context.lineTo$2(0, left + 7 * this.width / 10, $top);
      $.context.lineTo$2(0, left + 8 * this.width / 10, bottom);
      $.context.lineTo$2(0, left + 9 * this.width / 10, $top);
      $.context.lineTo$2(0, left + 10 * this.width / 10, bottom);
      t1 = $.normContext;
      J.set$fillStyle$x(t1, "yellow");
      t1.closePath();
...
["", "main.dart", , F, {
  ...
  main: [function() {
    ...
    if ($.Game_instance == null) {
      ...
      t2.Player$0();
      t1 = new U.MainMenu(null, null, null, null, null, null, 0, 0, 0, false, false, false, null, null, 0, 0, false);
      t1.MainMenu$0();
