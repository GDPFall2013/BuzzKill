...
//Attack animation implementation for Droid - currently setup for testing purposes
  
  droidXpos = droid.x;
  buzzXpos = player.x;
  droidXdist = droidXpos - buzzXpos;
  
  if (droidXdist <= 100 && )
  {
    sprite = new SpriteSheet("./content/enemies_attack_spritesheet.png",0,442,78,108);
